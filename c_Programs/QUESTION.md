...
8. WAP which reads two integer values from the user and calculates sum, difference and product 5, using switch statement and ask if user want to continue other calculation terminate the 5. program.
9. WAP to display the even numbers that comes between 9 to 21
10. WAP to calculate and display the sum of numbers from 1 to N.
11. WAP to display multiplication table of number given by the user.
12. WAP to calculate and display factorial of N.
13. WAP to display the given pattern.
    1
    12
    123
    1234
...
4. WAP to convert a given decimal number into a binary number.
5. WAP to convert a given binary number into a decimal number.
6. WAP to check whether the given number is prime or composite.
