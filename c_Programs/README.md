...
1. Basic programming in C to know:
    ...
    b. Keywords, Datatypes, Operators
    c. Header files, Escape keys
    d. Preprocessor directives, Data Conversion types
    e. Strings, Control statements (Looping, selecttion, continue, break etc.)
    f. Array, Matrix (1-D, 3-D)
    g. Mathematical logic of conversion etc.

2. Medium complexity programming in C to know:
